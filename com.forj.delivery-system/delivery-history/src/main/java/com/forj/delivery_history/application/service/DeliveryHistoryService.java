...
import com.forj.delivery_history.infrastructure.messaging.DeliveryHistoryDeliveryCompleteMessage;
...
public class DeliveryHistoryService {
    ...
    public void createDeliveryHistory(
        ...
        while (!currentHubId.equals(endHubId)) {
            ...
            HubMovement nextMovement = hubMovementRepository.findBydepartureHubId(currentHubId)
    ...
    public void arrivedHub(){
        ...
        DeliveryHistory currentDelivery = deliveryHistoryRepository.findFirstByDeliveryAgentIdAndStatus(userId, DeliveryHistoryStatusEnum.PROGRESS )
        ...
        DeliveryHistory nextDelivery = deliveryHistoryRepository.findFirstByDeliveryAgentIdAndStatus(userId, DeliveryHistoryStatusEnum.READY )
                .orElseThrow(() -> {
                    ...
                    DeliveryHistoryDeliveryCompleteMessage event = new DeliveryHistoryDeliveryCompleteMessage(userId);
